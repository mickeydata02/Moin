...
BOT_TOKEN = "7347459264:AAF65dADCVbwh2iJ4WNN2SYGIrS_5N7y4Sc"
...
async def bgmi(update: Update, context: CallbackContext):
    ...
    if user_id not in user_access:
        await update.message.reply_text("⚠️ You don't have access. Please pay ₹500 for 7 days access using /pay. CONTACT @GOKU_VAMPIRE")
        return
...
async def trial(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id="8800616445", text=admin_message)
